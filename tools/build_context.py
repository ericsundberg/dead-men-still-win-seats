...
This tool lives in /tools and reads settings from:

  tools/build_context_settings.config

Default settings point the scanner at:
...
Usage:
  ...
  python3 tools/build_context.py --config tools/build_context_settings.config
  python3 tools/build_context.py --scan-root src
  python3 tools/build_context.py --scan-root src --scan-root public
  python3 tools/build_context.py --tree-only
  python3 tools/build_context.py --include-svg
  python3 tools/build_context.py --include-lockfiles
"""
