...
export interface CampaignMetrics {
  readonly publicSuspicion:
    number;

  readonly partyConfidence:
    number;

  readonly voterEnergy:
    number;
}
...
export interface CampaignState {
  ...
  readonly activeEventInstanceId:
    string | null;

  readonly queuedEventIds:
    readonly string[];

  readonly completedEventIds:
    readonly string[];
...
export const defaultCampaignStartingStafferCount =
  3;

export const defaultCampaignPersonnel:
  CampaignPersonnel = {
    staffers:
      defaultCampaignStartingStafferCount,

    surrogates:
      0,
  };

export const defaultCampaignStartingValues:
  CampaignStartingValues = {
    resources: {
      cash:
        100_000,
